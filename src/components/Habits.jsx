...
export default function Habits() {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-4">Orari Sonno/Veglia</h2>
        <div className="space-y-3">
          <label className="block">
            A letto:
            <input type="time" value={bedtime} onChange={(e) => setBedtime(e.target.value)} className="ml-2" />
          </label>
          <label className="block">
            Sveglia:
            <input type="time" value={wakeTime} onChange={(e) => setWakeTime(e.target.value)} className="ml-2" />
          </label>
        </div>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-4">Malus</h2>
        {malus.map((m, idx) => (
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-4">Attività quotidiane ricorrenti</h2>
